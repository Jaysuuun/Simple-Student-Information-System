...
COURSE = tk.StringVar()
course = tk.Label(frame1,text="Course Code",font=('Helvetica',20,"bold"))
...
courseid = tk.Label(courseframe,text="Course Code",font=('Helvetica',15,"bold"))
...
coursename = tk.Label(courseframe,text="Course Name",font=('Helvetica',15,"bold"))
...
Listtable.heading("COURSEID",text="COURSE CODE")
Listtable.heading("COURSE",text="COURSE")

Listtablecourse.heading("COURSE ID",text="COURSE CODE")
